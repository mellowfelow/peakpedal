...
export const BRANDS = [
  ...
  { slug: 'cannondale', name: 'Cannondale', keyword: 'cannondale electric bike', description: 'Cannondale is a US bike brand producing the Moterra full-power eMTB and the Moterra SL lightweight platform, both on Bosch and Shimano motors respectively.' },
...
const RAW_PRODUCTS = [
  ...
  ['Cannondale Moterra 3', 'Cannondale', 'Full Suspension', 'Trail', 4000, 5000, 'Bosch Performance CX', '150/140mm', 'cannondale-moterra-3', 'Entry'],
  ...
  ['Cannondale Moterra SL 2', 'Cannondale', 'Lightweight SL', 'Trail', 5000, 6000, 'Shimano EP801', '140/130mm', 'cannondale-moterra-sl-2', null],
